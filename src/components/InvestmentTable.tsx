  ...
  return (
    <div className="rounded-2xl bg-slate-900 border border-slate-800 p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-base font-semibold text-white">재테크 수익률</h2>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {rows.map((r) => (
              <tr key={r.id} className="border-b border-slate-800/50 hover:bg-slate-800/30 transition-colors">
                ...
                <td className="py-3 pr-4 text-slate-200 whitespace-nowrap text-xs">
                  {formatKRWFull(r.currentPrice)}
                  {r.type === 'gold' && <span className="text-slate-600">/돈</span>}
                </td>
                <td className="py-3 pr-4 text-white font-medium whitespace-nowrap text-xs">{formatKRWFull(r.currentValue)}</td>
                ...
                <td className="py-3">
                  ...
                  <div className="mt-1 h-1 w-16 rounded-full bg-slate-800 overflow-hidden">
                    <div
          ...
          <tfoot>
            <tr className="border-t border-slate-700">
              ...
              <td className="pt-3 text-white font-semibold text-xs">{formatKRWFull(totalCurrent)}</td>
